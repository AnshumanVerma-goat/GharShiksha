...
export default function TrustStrip() {
  ...
  return (
    <div className="bg-[#2E6F5E] py-12 w-full overflow-hidden shadow-lg relative z-20">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-6 md:gap-8 divide-x divide-[#F5F1E8]/20">
          {stats.map((stat, idx) => (
            <motion.div 
              ...
              key={idx} 
              className="text-center text-[#F5F1E8] px-2"
            >
              <div className="font-serif text-3xl md:text-5xl mb-2">{stat.value}</div>
